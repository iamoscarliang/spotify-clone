...
public class GetMusicsByAlbumIdUseCaseTest {

    private MusicRepository mRepository;
    private GetMusicsByAlbumIdUseCase mUseCase;

    @Before
    public void init() {
        mRepository = mock(MusicRepository.class);
        mUseCase = new GetMusicsByAlbumIdUseCase(mRepository);
    }

    @Test
    public void execute() {
        mUseCase.execute("foo");
        verify(mRepository).getMusicsByAlbumId("foo");
    }
