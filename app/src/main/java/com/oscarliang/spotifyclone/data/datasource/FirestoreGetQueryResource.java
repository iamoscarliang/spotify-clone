...
public abstract class FirestoreGetQueryResource<ResultType> {

    private final Class<?> mClazz;

    private final MutableLiveData<Resource<ResultType>> mResult = new MutableLiveData<>();

    public FirestoreGetQueryResource(Class<?> clazz) {
        mClazz = clazz;
        init();
    }
    ...
    @NonNull
    @MainThread
    protected abstract Query createCall();
