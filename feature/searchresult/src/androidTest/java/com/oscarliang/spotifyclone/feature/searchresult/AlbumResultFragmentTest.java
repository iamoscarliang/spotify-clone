...
public class AlbumResultFragmentTest {
    ...
    public void setUp() {
        ...
        viewModel = mock(AlbumResultViewModel.class);
        when(viewModel.getResult()).thenReturn(result);
        when(viewModel.getLoadMoreState()).thenReturn(loadMoreState);

        FragmentScenario<AlbumResultFragment> scenario = FragmentScenario.launchInContainer(
                AlbumResultFragment.class,
                null,
                new FragmentFactory() {
                    @NonNull
                    @Override
    ...
    public void testSuccess() {
        result.onNext(Result.success(createAlbums(2, UNKNOWN_ID, "foo")));
    ...
    public void testLoadNextPage() {
        result.onNext(Result.success(createAlbums(20, UNKNOWN_ID, "foo")));
    ...
    public void testNavigate() {
        result.onNext(Result.success(singletonList(createAlbum("foo", UNKNOWN_TITLE))));
